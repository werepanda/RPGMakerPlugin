...
// 2023-03-20 Ver.1.2.0 fix for BattleItemText blank.
// 2025-11-04 Ver.1.2.1 fix for no items and weapons.

/*:
 * @target MV MZ
 * @plugindesc change weapon equipment by the "Item" command in battle.
 * @author panda(werepanda.jp)
 * @url https://www.werepanda.jp/blog/20210605222257.html
 * 
...
(() => {
	...
	const BattleItemText = parameters['BattleItemText'];
	...
	Window_ActorCommand.prototype.addItemCommand = function() {
		const text = (BattleItemText === '') ? TextManager.item : BattleItemText;
		this.addCommand(text, "item");
	};
